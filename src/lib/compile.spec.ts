...
test('compile', t => {
  t.test('fixtures', t => {
    t.test('compile a normal definition', t => {
      ...
      return compile(root, ['main', 'browser'], { name: 'root', cwd: __dirname, ambient: false, meta: true, emitter })
        .then((out) => {
    ...
    t.test('compile export equals', t => {
      ...
      return compile(
        file,
        ['main', 'browser'],
        { name: 'foobar', cwd: __dirname, ambient: false, meta: false, emitter }
      )
        .then(out => {
          t.equal(out.results.main, [
    ...
    t.test('compile export default', t => {
      ...
      return compile(
        file,
        ['main'],
        { name: 'test', cwd: __dirname, ambient: false, meta: false, emitter }
      )
        .then(out => {
          t.equal(out.results.main, [
    ...
    t.test('compile duplicate files from different import contexts', t => {
      ...
      return compile(root, ['main'], { name: 'test', cwd: __dirname, ambient: false, meta: false, emitter })
        .then(out => {
          t.equal(out.results.main, [
    ...
    t.test('compile module augmentation', t => {
      ...
      return compile(file, ['main'], { name: 'test', cwd: __dirname, ambient: false, meta: false, emitter })
        .then(out => {
          t.equal(out.results.main, [
    ...
    t.test('compile an ambient definition', t => {
      ...
      return compile(node, ['main'], { name: 'name', cwd: __dirname, ambient: true, meta: false, emitter })
        .then(out => {
          t.equal(out.results.main, [
            'declare module \'fs\' {',
    ...
    t.test('compile inline ambient definitions', t => {
      ...
      return compile(node, ['main', 'browser'], { name: 'name', cwd: __dirname, ambient: true, meta: true, emitter })
        .then(out => {
          const contents = [
            `// Generated by typings`,
  ...
  t.test('missing error', t => {
    ...
    return compile(node, ['main'], { name: 'test', cwd: __dirname, ambient: false, meta: false, emitter })
  ...
  t.test('ambient flag compile error', t => {
    ...
    return compile(node, ['main'], { name: 'name', cwd: __dirname, ambient: false, meta: false, emitter })
      .catch(function (result) {
        t.equal(
          result.message,
  ...
  t.test('external compile error', t => {
    ...
    return compile(node, ['main'], { name: 'test', cwd: __dirname, ambient: true, meta: false, emitter })
      .catch(function (result) {
        t.equal(
          result.message,
  ...
  t.test('no main or typings error', t => {
    ...
    return compile(main, ['main'], { name: 'main', cwd: __dirname, ambient: false, meta: false, emitter })
  ...
  t.test('override dependency with local file', t => {
    ...
    return resolveNpmDependencies({ cwd: FIXTURE_DIR, dev: false, emitter })
      .then(tree => {
        return compile(tree, ['browser'], { name: 'main', cwd: __dirname, ambient: false, meta: false, emitter })
      })
      .then(out => {
        t.equal(out.results.browser, [
    ...
    return resolveNpmDependencies({ cwd: FIXTURE_DIR, dev: false, emitter })
      .then(tree => {
        return compile(
          tree,
          ['main', 'browser'],
          { name: 'main', cwd: __dirname, ambient: false, meta: false, emitter }
        )
      })
      .then(out => {
        t.equal(out.results.main, [
  ...
  t.test('resolve files array', t => {
    ...
    return compile(tree, ['main', 'browser'], { name: 'test', cwd: __dirname, ambient: false, meta: false, emitter })
      .then(function (out) {
        t.equal(out.results.main, [
